...
export const HomeHeader1 = () => {
  return (
    <header className="flex min-h-20 items-center gap-3 border-b px-4 py-4 sm:gap-4 sm:px-8">
      ...
      <Button className="text-foreground hidden h-10 rounded-xl bg-lime-400 px-4 hover:bg-lime-500 sm:inline-flex">
        Click to upgrade
      </Button>
      <Avatar className="text-foreground size-9 shrink-0 bg-[#cbb5f4]">
